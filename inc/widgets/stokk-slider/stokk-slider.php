<?php
/*
Widget Name: Stokk.co Main Slider
Description: Slider Industrial Metallics Wedding Website
Author: Stokk.co Team
Author URI: https://stokk.co
*/

class Stokk_mainslider_Widget extends SiteOrigin_Widget {
	function __construct() {
		
		parent::__construct(
			'sow-stokk-mainslider',
			__( 'Stokk.co Main Slider', 'so-widgets-bundle' ),
			array(
				'description' => __( 'An Stokk.co main slider widget.', 'so-widgets-bundle' ),
...
siteorigin_widget_register('sow-stokk-mainslider', __FILE__, 'Stokk_mainslider_Widget');
